...
import org.example.repository.exception.EntityUpdateFailedException;
...
public class RepositoryImpl <T> implements Repository <T> {
    ...
    public void save(T entity) throws EntityUpdateFailedException {
        ...
        try (Session session = SessionManager.getSessionFactory().openSession()) {
            ...
            throw new EntityUpdateFailedException("Save falided for " + entityClass.getName(), e);
        }
    }
    ...
    public void update(T entity) throws EntityUpdateFailedException {
        ...
        try (Session session = SessionManager.getSessionFactory().openSession()) {
            ...
            throw new EntityUpdateFailedException("Update falided for " + entityClass.getName(), e);
        }
    }
    ...
    public void delete(T entity) throws EntityUpdateFailedException {
        ...
        try (Session session = SessionManager.getSessionFactory().openSession()) {
            ...
            throw new EntityUpdateFailedException("Delete falided for " + entityClass.getName(), e);
        }
    }
